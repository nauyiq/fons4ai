...
└─ fons4ai-ai-capability
   ├─ fons4ai-ai-capability-common
   └─ fons4ai-ai-capability-spring-ai-starter
```
...
- `fons4ai-rag-spring-ai-starter` 只依赖 `fons4ai-ai-capability-common` 的图片识别契约，不强制传递 AI Capability Starter。
...
- 决策 D-002：新增 `fons4ai-tool` 和 `fons4ai-ai-capability`，均采用 `common + spring-ai-starter`。
