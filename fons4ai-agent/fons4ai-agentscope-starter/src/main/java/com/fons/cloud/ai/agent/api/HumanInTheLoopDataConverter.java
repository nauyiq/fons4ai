...
public interface HumanInTheLoopDataConverter {
     ...
     */
    HumanInTheLoopInfo toHitlInfo(AgentRunContext context, RequireUserConfirmEvent event);
     ...
     */
    UserMessage toResumeMessage(HitlRequestInfo requestInfo, List<ToolUseBlock> toolCalls);
