...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| BS-xxx | <能力> | <变体/全部> | <入口> | <服务> | <领域对象> | <Mapper/Repo> | <外部> | <事务> | <异常> | <验证> | 已验证/待确认 |
...
| 业务能力 | 业务变体 | 入口/契约 | 应用编排 | 策略/流程/扩展点 | Adapter/Gateway/Remote | DTO/参数转换 | 状态映射 | 幂等/重试 | 不得修改的公共抽象 | 状态 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| <能力> | <变体> | <入口> | <服务> | <Process/Strategy/Handler> | <网关> | <DTO> | <映射> | <规则> | <公共接口> | 已验证/待确认 |
...
| --- | --- | --- | --- | --- |
| BS-xxx | <变体> | 单元/集成/契约/手动 | 规则/异常/事务/状态映射/幂等 | 已验证/待确认 |
